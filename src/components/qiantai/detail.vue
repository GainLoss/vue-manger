    ...
    <div class="col-sm-12" style="margin-top:10px;">
        <div class="row">
            ...
            <div class="col-sm-4" style="text-align:left;">
                <div class="share">
                    <p style="font-size:18px;">分享到...</p>
                    <p class="icon">
                        <span><img src="static/image/detail/qq.png" style="width:20px;height:20px">分享到QQ</span>
                        <span><img src="static/image/detail/weixin.png" style="width:20px;height:20px">分享到微信</span>
                        <span><img src="static/image/detail/weibo.png" style="width:20px;height:20px">分享到微博</span>
                    </p>
                </div>
            </div>
        </div>
